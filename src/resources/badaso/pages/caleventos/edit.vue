          ...
          <vs-card>
            ...
            <vs-row>
              ...
              >
                ...
                <template v-if="dataRow.edit && dataRow.type !== 'hidden' && seShow(dataRow)">
                  <badaso-text
                  ...
                  <badaso-multiple-select
                    ...
                    :placeholder="dataRow.displayName"
                    :slug="dataType.slug"
                    :tableDestino="dataRow.relation.destinationTable"
  ...
  methods: {
            ...
            if (
              ...
              data.value = new Date(dateValue);
                ...
                data.type == "password"
                  ...
                  let destinationTableId =  this.$caseConvert.stringSnakeToCamel(data.relation.destinationTable) + 'Id'
                  data.value = []
    ...
    seShow(dataRow) {
      ...
      if (categoria.value=="1") {
        ...
        nome.details.size = 6;
        categoria.details.size = 2;
        dataInicio.details.size= 2; 
        status.details.size = 2;
